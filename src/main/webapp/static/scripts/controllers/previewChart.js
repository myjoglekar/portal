...
//        var h = 400 - m[0] - m[2]; // height
    ...
    var x_range;
    var y_range;
    d3.json(preValue.url, function (error, json) {
        var data;
        if (!json)
    ...
    function render(data) {
        ...
        var graph = d3.select("#previewGraph").append("svg:svg")
...
//            height = 500 - margin.top - margin.bottom;
    ...
    var svg = d3.select("#previewGraph").append("svg")
...
function barChart(preValue) {
    ...
    d3.json(preValue.url, function (error, data) {
        data.forEach(function (d) {
            d.Letter = d.Letter;
            d.Freq = +d.Freq;
        });
...
function groupedBarChart(preValue) {
    var margin = {
        top: 20,
        right: 20,
        bottom: 30,
...
//    var h = 400;
    ...
    d3.json(preValue.url, function (error, data) {
        var vis = d3.select('#previewGraph').append("svg:svg").data([data]).attr("width", w).attr("height", h).append("svg:g").attr("transform", "translate(" + r + "," + r + ")");
...
function donutChart(preValue) {
    // console.log("Donut : ", preValue.url)
    var width = 300;
    var height = 250;
